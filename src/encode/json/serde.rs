...
const _IMPL_DESERIALIZE_FOR_JsonEncoderConfig: () =
    {
        extern crate serde as _serde;
        #[automatically_derived]
        impl _serde::Deserialize for JsonEncoderConfig {
            fn deserialize<__D>(deserializer: __D)
             -> _serde::export::Result<JsonEncoderConfig, __D::Error> where
                ...
                impl _serde::de::Visitor for __Visitor {
                    ...
                    fn expecting(&self,
                                 formatter:
                                     &mut _serde::export::fmt::Formatter)
                     -> _serde::export::fmt::Result {
                        formatter.write_str("struct JsonEncoderConfig")
                    }
                    #[inline]
                    fn visit_seq<__V>(self, _: __V)
                     -> _serde::export::Result<JsonEncoderConfig, __V::Error>
                     where __V: _serde::de::SeqVisitor {
                        let __field0 = _serde::export::Default::default();
                        Ok(JsonEncoderConfig{_p: __field0,})
                    }
                    #[inline]
                    fn visit_map<__V>(self, mut visitor: __V)
                     ...
                     where __V: _serde::de::MapVisitor {
                        ...
                        Ok(JsonEncoderConfig{_p:
                                                 _serde::export::Default::default(),})
                    }
                }
                const FIELDS: &'static [&'static str] = &[];
                deserializer.deserialize_struct("JsonEncoderConfig", FIELDS,
                                                __Visitor)
            }
        }
    };
